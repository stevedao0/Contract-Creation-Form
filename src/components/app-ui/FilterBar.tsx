...
}: {children: React.ReactNode;onClear?: () => void;hasActive?: boolean;resultSummary?: React.ReactNode;}) {
  return (
...
}: {label: string;children: React.ReactNode;width?: string;}) {
  return (
