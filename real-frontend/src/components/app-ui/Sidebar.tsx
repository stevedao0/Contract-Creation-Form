...
export function Sidebar({
  ...
  return (
    <aside className="vc-enterprise-sidebar hidden md:flex h-screen sticky top-0 z-30 relative overflow-hidden">
      ...
      <div className="vc-enterprise-sidebar-panel w-[248px] flex flex-col relative overflow-hidden">
